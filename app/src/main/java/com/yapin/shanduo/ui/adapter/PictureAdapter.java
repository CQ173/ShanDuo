...
import com.yapin.shanduo.ui.activity.PictureActivity;
...
public class PictureAdapter extends RecyclerView.Adapter<PictureAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Glide.with(activity).load(Utils.getLocalImagePath(url))
                .placeholder(R.color.font_gray_color)
                .error(R.color.font_gray_color)
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (selectList.size() > left - 1) {
                        ToastUtil.showShortToast(context, "最多只能选择" + left + "张照片！");
                        return;
                    }
