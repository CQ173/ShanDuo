...
import com.yapin.shanduo.im.ui.GroupManageMessageActivity;
...
public class GroupManageConversation extends Conversation {
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_me)+
                            ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_group_invite)+
                            to+
                            ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_group_invite)+
                                ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_me)+
                                ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_me)+
                            ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+ShanDuoPartyApplication.getContext().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return ShanDuoPartyApplication.getContext().getString(R.string.conversation_system_group);
    }
