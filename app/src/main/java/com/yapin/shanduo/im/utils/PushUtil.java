...
public class PushUtil implements Observer {
    ...
    private void PushNotify(TIMMessage msg){
        ...
        NotificationManager mNotificationManager = (NotificationManager) ShanDuoPartyApplication.getContext().getSystemService(ShanDuoPartyApplication.getContext().NOTIFICATION_SERVICE);
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(ShanDuoPartyApplication.getContext());
        Intent notificationIntent = new Intent(ShanDuoPartyApplication.getContext(), MainActivity.class);
        notificationIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP
                | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        PendingIntent intent = PendingIntent.getActivity(ShanDuoPartyApplication.getContext(), 0,
...
//                .setNumber(++pushNum) //设置通知集合的数量
    ...
    public void reset(){
        NotificationManager notificationManager = (NotificationManager)ShanDuoPartyApplication.getContext().getSystemService(ShanDuoPartyApplication.getContext().NOTIFICATION_SERVICE);
