...
public class ImageUrlModelImpl implements UploadLoadModel{
    @Override
    public void load(final OnLoadListener<String> listener, List<String> paths) {
        ...
        OkHttp.upload(context, ApiUtil.UPLOAD_IMG_URL, params , paths, new JavaOkCallback() {
            @Override
