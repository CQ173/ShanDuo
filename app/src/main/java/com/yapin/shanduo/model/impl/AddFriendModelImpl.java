...
/**
 * 作者：L on 2018/5/29 0029 16:30
 */
public class AddFriendModelImpl implements AddFriendLoadModel {
    @Override
    public void load(final OnLoadListener<String> listener, String attention) {
        ...
        OkHttp.post(context, ApiUtil.ADD_FRIEND, params, new JavaOkCallback() {
            @Override
            public void onFailure(String msg) {
                Log.d("AddFriendModelImpl" , msg);
                listener.onError(msg);
            }

            @Override
            public void onResponse(String response) {
                Log.d("AddFriendModelImpl" , response);
                try {
