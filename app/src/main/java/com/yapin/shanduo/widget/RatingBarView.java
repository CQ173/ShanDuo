...
public class RatingBarView extends LinearLayout {
    ...
    public RatingBarView(Context context, AttributeSet attrs) {
        ...
        starPadding = ta.getDimension(R.styleable.RatingBarView_starPadding, 10);
        starImageSize = ta.getDimension(R.styleable.RatingBarView_starImageSize, 30);
    ...
    private ImageView getStarImageView(Context context, AttributeSet attrs) {
        ...
        para.setMargins(0, 0, Math.round(starPadding), 0);//设置每颗星星在线性布局的间距
        // TODO:you can change gap between two stars use the padding
//        imageView.setPadding(0, 0, 40, 0);
//        imageView.setPadding(Math.round(starPadding), 0, Math.round(starPadding) , 0);
