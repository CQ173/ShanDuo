...
public class ChatInput extends RelativeLayout implements TextWatcher,View.OnClickListener {
    ...
    private TextView voicePanel , btnSend;
    private LinearLayout emoticonPanel;
    private final int REQUEST_CODE_ASK_PERMISSIONS = 100;
    private ImageView btnVoice, btnKeyboard, btnEmotion;
    ...
    private void initView(){
        ...
        btnEmotion = (ImageView) findViewById(R.id.btnEmoticon);
        btnEmotion.setOnClickListener(this);
        morePanel = (LinearLayout) findViewById(R.id.morePanel);
        ImageView BtnImage = (ImageView) findViewById(R.id.btn_photo);
        BtnImage.setOnClickListener(this);
        ImageView BtnPhoto = (ImageView) findViewById(R.id.btn_image);
        BtnPhoto.setOnClickListener(this);
        ImageView btnVideo = (ImageView) findViewById(R.id.btn_video);
